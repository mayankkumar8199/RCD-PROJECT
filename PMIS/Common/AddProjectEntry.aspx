  ...
  <div class="panel-group">
    <div class="panel panel-primary">
      <div class="panel-heading" style="text-align:center; font-weight: bold;">Add Project
                ...
                <p style="float:right; margin:-13px -4px -8px;"><asp:ImageButton ID="btn_Back" runat="server"  OnClick="btn_Back_Click" Width="45px"   ImageUrl="~/PMIS/images/back_image.png"  /></p>
