<%@ Page Title="" Language="C#" MasterPageFile="~/PMIS/SiteMaster.master" AutoEventWireup="true" CodeFile="UpdateAddFinancial.aspx.cs" Inherits="PMIS_Common_UpdateAddFinancial" %>
...
--%>                        
                    ...
                    <div class="row" style="padding-top: 10px;">
                        ...
                        <div class="col-md-2 col-xs-12">
                            <asp:TextBox ID="txt_expenditure" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                        <div class="col-md-2 col-xs-12">
                    ...
                    <div class="row" style="padding-top: 10px; padding-bottom: 10px;">
                        ...
                        <div class="col-md-6 col-xs-6">
                            <asp:Button ID="btn_save" runat="server" Text="Update"  OnClick="btn_Update_Click" CssClass="btn btn-primary "
                                Width="80px" />
